...
public class Player {
	...
	public Player(Integer id, String full_name, String gender, String email, String password, LocalDate dob,
	...
	public void setIsFindingMatch(Boolean isFindingMatch) {
